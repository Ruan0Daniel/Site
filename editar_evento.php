                    ...
                    <ul id="sidebarnav">
						...
						<li class="sidebar-item item">
								...
								<ul>
									...
									<li> <a href="editar_evento.php"> <b>Editar Eventos</b> </a> </li>
								</ul> 
						</li>
        ...
        <div class="page-wrapper">
            ...
            <div class="page-breadcrumb">
                <div class="row align-items-center">
                    <div class="col-5">
                        <h4 class="page-title">Editar Eventos</h4>
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-12">  <!-- bloco de abertura -->
                        <div class="card">
                            <div class="card-body">
                                <h4 class="card-title">Alterar um Evento</h4>
                                <h6 class="card-subtitle"> Informe a OS do evento</h6> <br> <br>
